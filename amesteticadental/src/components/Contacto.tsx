...
const COPY = {
    es: {
        ...
        lead: "Cada tratamiento empieza con una evaluación inicial donde entendemos exactamente qué querés lograr y definimos el plan indicado para tu caso.",
        scarcity: "Agenda limitada · Solo 4 evaluaciones iniciales disponibles este mes",
        waCta: "Solicitar evaluación por WhatsApp",
        waHref: "https://api.whatsapp.com/send?phone=5491170219298&text=Hola%20buenas!%20%F0%9F%91%8B%20Me%20gustar%C3%ADa%20solicitar%20una%20evaluaci%C3%B3n%20inicial.",
        location: "Ubicación",
        schedule: "Horario",
...
{t.lead}
            ...
            <div className="mt-12 pt-8 border-t border-oro/10 flex flex-col items-center gap-6 text-center">
                ...
                {/* La fila "Red AM" vivía acá. Se mudó a components/RedAM.tsx, colgada del
                    layout raíz, para que salga en las 76 páginas y no sólo en las 21 que
