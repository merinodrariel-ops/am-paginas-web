...
function VideoCard({ video }: { video: typeof videosTestimonios[0] }) {
    ...
    return (
        <div className="relative aspect-[9/16] rounded-2xl overflow-hidden bg-carbon-soft border border-oro/10 group">
            {!playing ? (
                <>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <button
                            ...
                            className="w-16 h-16 rounded-full bg-oro/90 hover:bg-oro flex items-center justify-center transition-all group-hover:scale-110"
