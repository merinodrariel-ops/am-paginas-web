          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
              {[
                ...
                { src: "https://res.cloudinary.com/drctvgyqd/image/upload/q_auto,f_auto/casos/carilla-unitaria-incisivo-central-oscurecido/carilla-unitaria-incisivo-central-ceramica-resultado-natural-dr-ariel-merino-am-estetica-dental", alt: "Resultado natural carilla cerámica unitaria incisivo central — Dr. Ariel Merino AM Estética Dental" },
                { src: "https://res.cloudinary.com/drctvgyqd/image/upload/q_auto,f_auto/casos/galeria/caso-italiano-carillas-ceramicas-02-am-estetica-dental", alt: "Caso paciente italiano carillas cerámicas 02 — AM Estética Dental Buenos Aires" },
              ].map((foto) => (
            ...
            <div className="mt-8 text-center">
              <Link href="/casos/20-carillas-porcelana-apinamiento-sin-ortodoncia" className="inline-flex items-center gap-2 text-oro/70 hover:text-oro font-manrope text-sm transition-colors">
