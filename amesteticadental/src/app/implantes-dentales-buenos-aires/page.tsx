                ...
                <section className="px-6 py-16 border-y border-oro/8 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        {[
                            ...
                            { tipo: "La corona definitiva", precio: "USD 1.500", nota: "Igual con los dos sistemas. Va a los 2 o 3 meses, cuando el implante integró" },
                            { tipo: "Total terminado", precio: "desde USD 3.000", nota: "USD 3.500 si el implante es Straumann®" },
                        ].map((o) => (
                ...
                <section className="px-6 py-16 border-t border-oro/8 max-w-6xl mx-auto">
                    ...
                    <div className="space-y-4 max-w-3xl">
                        {[
                            ...
                            { q: "¿Cuál es la inversión en un implante dental en Buenos Aires?", a: "Hay dos opciones: el implante Neodent® a partir de USD 1.500 y el Straumann® a partir de USD 2.000. Ese valor es la cirugía completa — incluye la extracción, el relleno de hueso y la membrana que el caso necesite. La corona definitiva vale USD 1.500 y es la misma con los dos sistemas. Se coloca 2 o 3 meses después, cuando el implante integró, así que el tratamiento terminado queda a partir de USD 3.000 con Neodent® o USD 3.500 con Straumann®." },
                ...
                <section className="px-6 py-16 border-t border-oro/8 max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-crema/60 text-sm leading-relaxed mb-4">Trabajamos con implantes del Grupo Straumann: Neodent (gama alta) y Straumann (tope de gama, #1 del mundo). Straumann se fabrica en Suiza; Neodent es una marca brasileña que el grupo adquirió y hoy fabrica bajo sus estándares. Los dos son de titanio y están entre los sistemas con mayor respaldo científico del sector. Si en algún caso no hubiera disponible la medida que hace falta, se resuelve con un implante nacional de gama equivalente, siempre conversado antes.</p>
