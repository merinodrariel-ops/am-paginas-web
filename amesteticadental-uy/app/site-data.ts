...
export const localFaqs = [
  ...
  },
  {
    ...
    answer: "El foco estará en estética dental, diseño de sonrisa, carillas cerámicas, rehabilitación oral y planificación digital. El alcance definitivo de cada tratamiento se comunica al abrir la agenda y siempre depende de una evaluación clínica individual.",
  },
  {
    question: "¿Las carillas requieren preparación dental?",
    answer: "Cada caso se planifica de forma individual. Trabajamos con un enfoque mínimamente invasivo y con la menor preparación compatible con un resultado estable y natural; en muchos casos es necesaria una preparación mínima.",
  },
  {
...
export const treatmentPages = {
  "carillas-dentales-montevideo": {
    ...
    intro: "AM Estética Dental prepara en Carrasco una propuesta centrada en carillas cerámicas diseñadas para integrarse a la expresión, las proporciones faciales y la función de cada paciente.",
    detail: "La indicación, el material y el grado de preparación se definen sólo después de evaluar el caso. La planificación digital sirve para conversar decisiones con claridad antes de avanzar.",
  },
  "diseno-de-sonrisa-montevideo": {
    title: "Diseño de sonrisa en Montevideo",
    eyebrow: "Estética dental en Carrasco",
    intro: "Una sonrisa natural no se resuelve con una fórmula. Se estudian proporciones, color, textura, función y la manera en que cada persona se expresa.",
    detail: "El enfoque de AM combina diagnóstico, diseño digital y ejecución clínica. La nueva sede uruguaya abrirá con esa misma filosofía de planificación y seguimiento.",
  },
  "estetica-dental-montevideo": {
    title: "Estética dental en Montevideo",
    eyebrow: "Próxima apertura · Carrasco",
    intro: "La estética dental de alto nivel se apoya en criterio clínico, materiales indicados y una mirada que evita resultados genéricos.",
    detail: "AM Estética Dental prepara su presencia en Uruguay para pacientes que priorizan resultados armónicos, diagnósticos claros y procesos bien planificados.",
  },
  "carillas-de-porcelana-montevideo": {
    title: "Carillas de porcelana en Montevideo",
    eyebrow: "Planificación clínica individual",
    intro: "Las carillas de porcelana permiten corregir forma, color, proporción y pequeñas asimetrías cuando están correctamente indicadas.",
    detail: "El objetivo no es replicar una sonrisa estándar. Es construir una solución coherente con el rostro, la mordida y los objetivos de cada paciente.",
  },
} as const;
