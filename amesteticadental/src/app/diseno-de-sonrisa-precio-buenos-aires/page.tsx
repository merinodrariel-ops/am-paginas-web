...
const OPCIONES = [
    ...
    { titulo: "Diseño de sonrisa completo", desc: "10 a 12 carillas. Ampliación de arco + corrección de color y forma.", precio: "USD 9.000 – 14.400", tiempo: "10 días" },
    { titulo: "Smile makeover integral", desc: "Diseño completo con corrección de mordida y dimensión vertical.", precio: "USD 18.000 – 24.000", tiempo: "15 días" },
];
                ...
                <section className="px-6 py-16 max-w-6xl mx-auto">
                    ...
                    <div className="space-y-4 max-w-3xl">
                        {[
                            ...
                            { q: "¿Cuánto cuesta un diseño de sonrisa en Buenos Aires?", a: "Como referencia, 4-6 piezas pueden partir desde USD 4.000, 10-12 carillas cerámicas van de USD 9.000 a 14.400 y una rehabilitación integral de 20 piezas ronda USD 18.000 a 24.000. La inversión exacta se define luego de evaluar el caso." },
                        ].map(({ q, a }) => (
