...
export const metadata: Metadata = {
  title: "Cuando una sonrisa empieza en la encía",
  description:
    "Cómo se combinan los márgenes gingivales con los bordes incisales en el 5% de pacientes que llegan con los dientes impecables y el problema en la encía.",
