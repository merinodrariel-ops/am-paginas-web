...
export const metadata: Metadata = {
    ...
    title: "Carillas Dentales en Buenos Aires · Dr. Ariel Merino · AM Estética Dental",
    description: "Cambiá tu sonrisa con carillas de porcelana premium en Puerto Madero. Resultados naturales y definitivos con el Dr. Ariel Merino (Forbes Argentina). Ver casos reales y precios.",
    alternates: {
        canonical: "https://www.amesteticadental.com/carillas-dentales",
    },
    openGraph: {
        title: "Carillas Dentales en Puerto Madero | AM Estética Dental",
        description: "Carillas de porcelana mínimamente invasivas en Puerto Madero. Resultados definitivos en 2 a 3 sesiones con el Dr. Ariel Merino.",
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="mb-10">
                            ...
                            <h2 className="text-2xl font-manrope font-light text-crema">
                                Casos reales <span className="font-cormorant italic text-oro">de carillas en AM.</span>
                            </h2>
                            <p className="text-crema/45 font-manrope text-sm mt-3 max-w-xl">Diseños de sonrisa con carillas de porcelana. Resultados definitivos y naturales. Dr. Ariel Merino, Puerto Madero.</p>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                            {[
                                ...
                                { src: "https://res.cloudinary.com/drctvgyqd/image/upload/q_auto,f_auto/casos/galeria/caso-extremo-carillas-veneers-04-dr-ariel-merino-am-estetica-dental", alt: "Caso extremo carillas veneers 04 — Dr. Ariel Merino AM Estética Dental" },
                                { src: "https://res.cloudinary.com/drctvgyqd/image/upload/q_auto,f_auto/casos/galeria/caso-diseno-sonrisa-carillas-ceramicas-antes-despues-am-estetica-dental", alt: "Antes y después diseño de sonrisa con carillas cerámicas — AM Estética Dental Buenos Aires" },
                            ].map((foto) => (
