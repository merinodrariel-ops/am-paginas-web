...
export default function MapaSedes({ destacar = "montevideo" }: { destacar?: "montevideo" | "buenos-aires" }) {
  ...
  return (
    <figure className="m-0 overflow-hidden border border-oro/15">
      <Image className="block h-auto w-full" src={imagen.src} alt={imagen.alt} width={1014} height={570} sizes="(max-width: 800px) 100vw, 1180px" />
    </figure>
  );
}
