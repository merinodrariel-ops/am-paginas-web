 ...
 *
 *   node scripts/notify-indexnow.mjs /noticias/ia-diagnostico-odontologico /noticias/implantes-ceramica-zirconio-2026
 *      → notifica solo esas URLs (paths relativos o absolutos).
 */

const HOST = "www.thedentalreview.com";
const KEY = "86346b5cfff04c3f9721f6b8f09977e0";
...
async function main() {
  ...
  console.log(`→ Notificando ${urlList.length} URL(s) a IndexNow (Bing)...`);
