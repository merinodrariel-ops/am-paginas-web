      ...
      htmlContent: `
        <div style="font-family:sans-serif;max-width:520px;margin:0 auto;color:#1a1a1a">
          ...
          <div style="padding:40px 32px">
            ...
            <p style="line-height:1.7;color:#555">Quedaste en nuestra lista de espera para la apertura en <strong>Miraflores 1445, Oficina 202, Montevideo</strong>. Te escribimos en cuanto tengamos fecha confirmada.</p>
