    ...
    <div style={{ fontFamily: "var(--font-inter, Inter, sans-serif)" }}>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "72px 24px" }}>
        ...
        <div className="article-body">
          ...
          <h2>Quién edita esta publicación</h2>
          <p>The Dental Review es editada por el <a href="https://www.arielmerino.com" target="_blank" rel="noopener noreferrer">Dr. Ariel Merino</a>, odontólogo (MN 34.869) y director clínico de <a href="https://www.amesteticadental.com" target="_blank" rel="noopener noreferrer">AM Estética Dental</a>, en Puerto Madero, Buenos Aires.</p>
          <p>Lo decimos acá, y no en letra chica, porque hace a la lectura de lo que publicamos: cuando una nota menciona casos, datos o declaraciones de esa clínica o de su director, se indica expresamente y se enlaza la fuente para que cualquiera pueda contrastarla. Una publicación de nicho editada por alguien que ejerce la disciplina tiene una ventaja —acceso y criterio clínico de primera mano— y un sesgo evidente. Preferimos que el lector conozca las dos cosas antes de leer.</p>
