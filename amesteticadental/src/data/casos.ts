...
export const CASOS: Caso[] = [
    {
        ...
        seoTitle: "Rehabilitación Oral con Carillas, Coronas e Implantes",
...
Results correspond to this particular clinical case. Every treatment requires individual diagnosis and planning.`,
    ...
    },
    {
        ...
        descripcion: "Caso extremo de diseño de sonrisa con plano quebrado y bordes incisales fracturados. Paciente de Italia, residente en Milán, tratado en una semana con carillas cerámicas AM por el Dr. Ariel Merino en AM Estética Dental, Puerto Madero, Buenos Aires.",
...
In one week he went from a broken smile to a clean, harmonious and natural one. An extreme before and after, but with a very AM premise: the result should look powerful without looking artificial.`,
    ...
    },
    {
        ...
        descripcion: "Caso clínico de carilla unitaria en incisivo central oscurecido por traumatismo y tratamiento de conducto. Selección de color, maquillaje cerámico artístico, cementado adhesivo y resultado natural en AM Estética Dental, Puerto Madero, Buenos Aires.",
