...
export const metadata: Metadata = {
    ...
    description: "Los dos tratamientos que de verdad frenan el bruxismo, por el Dr. Merino: la placa que guía la mandíbula y la toxina botulínica en el masetero.",
