            ...
            <div className="max-w-4xl mx-auto relative">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-crema-muted font-manrope text-lg font-light max-w-xl mx-auto">
                        Cada tratamiento empieza con una consulta donde entendemos exactamente qué querés lograr. Sin presión, sin compromiso. Solo claridad.
                    </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
                    <a
                        href="https://api.whatsapp.com/send?phone=541170219298&text=Hola%20buenas!%20%F0%9F%91%8B%20Me%20gustar%C3%ADa%20agendar%20una%20consulta."
                        target="_blank"
