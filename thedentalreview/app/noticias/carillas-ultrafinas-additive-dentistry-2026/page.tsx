...
export const metadata: Metadata = {
  title: "Cada vez se lima menos: el auge de las carillas ultrafinas",
  description:
    "La resina impresa en 3D empuja el límite de lo conservador: carillas de 0,1 a 0,2 mm que reducen el desgaste del esmalte al mínimo.",
